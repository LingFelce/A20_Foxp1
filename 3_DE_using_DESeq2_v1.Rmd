---
title: "Differential expression and Venn diagrams (Adam's code)"
output: html_document
---


Update: 15th October 2018
Update: 10th July 2019 - added genes in volcano plots
...
symbol_data <- input %>% 
  filter(SYMBOL == "Cd19" | SYMBOL == "Iglv2" | SYMBOL == "Phyhip")
...
#Save Volcano Plot
ggsave("volcano/E6_1Volcanoplot.jpeg", device="jpeg") #In case you want to easily save to disk
...
#Save Volcano Plot
ggsave("volcano/E6_2Volcanoplot.jpeg", device="jpeg") #In case you want to easily save to disk
...
#Save Volcano Plot
ggsave("volcano/E7_1Volcanoplot.jpeg", device="jpeg") #In case you want to easily save to disk
...
#Save Volcano Plot
ggsave("volcano/E7_2Volcanoplot.jpeg", device="jpeg") #In case you want to easily save to disk
...
dt <- filter_genes(as.data.frame(res_e6.1), name="E6_1")
...
```{r , message=FALSE, echo=FALSE}
dt <- filter_genes(as.data.frame(res_e6.2), name="E6_2")
...
```{r , message=FALSE, echo=FALSE}
dt <- filter_genes(as.data.frame(res_e7.1), name="E7_1")
...
```{r , message=FALSE, echo=FALSE}
dt <- filter_genes(as.data.frame(res_e7.2), name="E7_2")
...
merge_down <- merge(E6_1_down, E6_2_down, by="gene", all = TRUE)
...
tiff("venn/e6_downregulated_venn.tiff")
vennDiagram(a, circle.col = wes_palette("Darjeeling1"))
#dev.off()
knitr::include_graphics("venn/e6_downregulated_venn.tiff")
...
write.csv(down, file="venn/e6_down.csv")
```
...
merge_down <- merge(E7_1_down, E7_2_down, by="gene", all = TRUE)
...
tiff("venn/e7_downregulated_venn.tiff")
vennDiagram(a, circle.col = wes_palette("Darjeeling1"))
#dev.off()
knitr::include_graphics("venn/e7_downregulated_venn.tiff")
...
write.csv(down, file="venn/e7_down.csv")
```
...
merge_down <- merge(merge_down, E7_1_down, by="gene", all = TRUE)
merge_down <- merge_down %>% 
  mutate(E7_1_LFC = log2FoldChange) %>% 
  select(-log2FoldChange)

merge_down <- merge(merge_down, E7_2_down, by="gene", all = TRUE)
merge_down <- merge_down %>% 
...
tiff("venn/all_downregulated_venn.tiff")
vennDiagram(a, circle.col = wes_palette("Darjeeling1"))
#dev.off()
knitr::include_graphics("venn/all_downregulated_venn.tiff")
...
write.csv(down, file="venn/all_down.csv")
```
...
merge_up <- merge(E6_1_up, E6_2_up, by="gene", all = TRUE)
...
tiff("venn/e6_upregulated_venn.tiff")
vennDiagram(a, circle.col = wes_palette("Darjeeling1"))
#dev.off()
knitr::include_graphics("venn/e6_upregulated_venn.tiff")
...
write.csv(up, file="venn/e6_up.csv")
...
merge_up <- merge(E7_1_up, E7_2_up, by="gene", all = TRUE)
...
tiff("venn/e7_upregulated_venn.tiff")
vennDiagram(a, circle.col = wes_palette("Darjeeling1"))
#dev.off()
knitr::include_graphics("venn/e7_upregulated_venn.tiff")
...
write.csv(up, file="venn/e7_up.csv")
```
...
merge_up <- merge(merge_up, E7_1_up, by="gene", all = TRUE)
merge_up <- merge_up %>% 
  mutate(E7_1_LFC = log2FoldChange) %>% 
  select(-log2FoldChange)

merge_up <- merge(merge_up, E7_2_up, by="gene", all = TRUE)
merge_up <- merge_up %>% 
  mutate(E7_2_LFC = log2FoldChange) %>% 
  select(-log2FoldChange)
...
tiff("venn/all_upregulated_venn.tiff")
vennDiagram(a, circle.col = wes_palette("Darjeeling1"))
#dev.off()
knitr::include_graphics("venn/all_upregulated_venn.tiff")
...
write.csv(up, file="venn/all_up.csv")
```
