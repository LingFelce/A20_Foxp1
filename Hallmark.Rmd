...
# list of pathways
hallmark_list <- list(adip, androgen,apical_junc,apoptosis,cholesterol,dna_repair,estrogen_early,fatty_acid,glycolysis,hypoxia,kras_up,mit_spindle,mtorc1,myc_v1,myc_v2,ox_phos,pancreas,protein_secretion,tnfa,uv_response_dn)
